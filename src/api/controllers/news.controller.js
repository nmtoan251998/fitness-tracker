...
module.exports.crawlData = async (req, res, next) => {
    try {
        ...
        try {
            ...
            throw new APIError({
                message: 'Error setting cron jobs'
            });
        }
    ...
    try {        
        ...
        try {
            ...
            return res.status(httpStatus.INTERNAL_SERVER_ERROR).json({
                msg: 'Error setting cronjob to automatically update posts data'
            }).end();
        }
        ...
        redisClient.get('news-health', async (error, value) => {
            if (error) {
                return res
                    ...
                    .json({
                        msg: 'Error getting cached crawled data'
                    })
                    .end();
            }
            ...
            if (!healthPosts) {
                ...
                return res.status(httpStatus.CREATED).json({
                    createdPosts: newsHealthPosts,
                    msg: 'Successfully update news health posts data'
                }).end();
            } else {
                ...
                return res.status(httpStatus.CREATED).json({
                    updatedPosts: updatedNewsHealthPosts,
                    msg: 'Successfully update news health posts data'
                }).end();
            }
        });
