...
},{"./lib/axios":"../../node_modules/axios/lib/axios.js"}],"../assets/js/socketio.js":[function(require,module,exports) {
"use strict";
...
document.querySelector("#get-mac").addEventListener("click", async event => {
  ...
  try {
    ...
    const connectedAddresses = await (0, _axios.default)({
      method: 'get',
      url: '/data/mac'
    }); // clear loading...
...
document.querySelector("#render-data").addEventListener("submit", async event => {
  ...
  try {
    ...
    const startPythonResult = await (0, _axios.default)({
      method: 'get',
    ...
    if (startPythonResult.status === 200) {
      const startSocketDataResult = await (0, _axios.default)({
        method: 'get',
        url: '/data/socket',
        params: {
          socketID: socket.id
...
},{"socket.io-client":"../../node_modules/socket.io-client/lib/index.js","axios":"../../node_modules/axios/index.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
},{}]},{},["../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","../assets/js/socketio.js"], null)